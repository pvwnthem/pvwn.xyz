    ...
    return (   
        <div className="w-full h-screen bg-black flex items-center text-white">         
            ...
            <div className='w-full h-full py-12'>  
                ...
                <div className=' md:w-2/3 w-full h-full bg-white mx-auto rounded-3xl'>
                    <div className='md:w-1/2 w-full h-full md:py-8 py-2 '>                       
                        <div className=' ml-8 mr-8 rounded-3xl h-full bg-black '>
                            <div className='w-36 h-36 mx-auto py-8 '>                     
                                <img src="waltuh.png" className='image rounded-full'></img>
                            </div>    
                            <div className='text-center md:mt-16 mt-12 text-6xl inter'>PVWN</div>     
